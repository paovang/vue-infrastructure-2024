<template>
    <div>
        ...
        <div class="card">
            ...
            >
                ...
                <Column field="lang_code" :header="$t('table.header.lang')" style="width: 25%"></Column>
  ...
  <script setup lang="ts">
    ...
    import { translateRealEstateTypeStore } from '../stores/trans-real-estate-type';
    ...
    const { register, update, remove, getAll, form, state, setStateFilter } = translateRealEstateTypeStore();
    ...
    const deleteItem = async (id: TranslateRealEstateTypeEntity) => {
        await remove(id);
    }

    const editItem = async (value: TranslateRealEstateTypeEntity) => {
        isEditing.value = true;

        setFieldValue('id', value.id);
        setFieldValue('name', value.name);
        selectedLocale.value = value.lang_code;
    ...
    const onUpdate = handleSubmit(async(values) => {
        ...
        form.lang_code = selectedLocale.value;
    ...
    const onSubmit = handleSubmit(async (values) => {
        form.name = values.name;
        form.real_estate_type_id = String(route.params.id);
        form.lang_code = selectedLocale.value;
    ...
    const confirmDelete = async (id: TranslateRealEstateTypeEntity) => {
        confirm.require({
