...
export const realEstateServiceStore = defineStore('real-estate-service-store', () => {
    ...
    type FilterType = Pick<RealEstateServiceEntity, 'country_id' | 'real_estate_type_id' | 'unit_price'>;
