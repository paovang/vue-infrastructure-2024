    ...
    <div>
        ...
        <div class="card">
            ...
            >
                ...
                <Column field="name" :header="$t('table.header.country')" style="width: 25%"></Column>
                <Column field="currency" :header="$t('table.header.currency')" style="width: 25%"></Column>
