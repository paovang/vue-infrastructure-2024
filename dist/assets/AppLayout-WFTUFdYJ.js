import{d as z,u as ee,a as ce,G as l,b as y,r as W,c as a,e as i,f,w as O,n as w,t as D,g as m,F as N,h as H,o as r,p as te,i as ne,_ as G,B as J,s as Z,m as d,j as C,k as K,l as F,q as U,v as b,Z as Y,D as j,x as de,R as ue,y as pe,z as me,A as $,T as fe,C as L,E as be,H as he,I as ve,J as q,S as ye}from"./index-pDnu6HUo.js";import{p as ge}from"./province.store-ezd5Ed8w.js";import{r as ke}from"./real-estate-service.store-tTDEf9C-.js";import{d as Se}from"./district.store-m6UJtciE.js";import{c as we}from"./country.store-pE2o4zGQ.js";import{s as _e}from"./index.esm-sEqHK9BX.js";import{u as Ie}from"./auth.store-ultV7EmB.js";import{s as Ee}from"./dropdown.esm-bqZRt2KG.js";import"./axios.config-Uzc7t5BD.js";import"./index.esm-nDJ-o48k.js";const R=e=>(te("data-v-3a8d789a"),e=e(),ne(),e),xe={class:"shadow-1 h-screen fixed z-2 surface-overlay"},Ce={class:"flex flex-column h-full white-space-nowrap"},Re=R(()=>i("img",{src:"https://logomaker.designfreelogoonline.com/media/productdesigner/logo/resized/1286_bird-01.png",style:{width:"38px"}},null,-1)),Ae=R(()=>i("span",{class:"font-bold text-3xl",style:{"margin-left":"10px"}},"UK LAO",-1)),Le=[Re,Ae],Oe=R(()=>i("br",null,null,-1)),De={class:"overflow-y-auto"},$e={class:"list-none p-0 m-0 overflow-hidden"},Ne={key:0},Be=R(()=>i("i",{class:"pi pi-users mr-2"},null,-1)),Pe={class:"font-medium"},Me={key:1},Ue=R(()=>i("i",{class:"pi pi-chart-line mr-2"},null,-1)),Te={class:"font-medium"},Ve={class:"list-none p-0 m-0 overflow-hidden"},je={class:"flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple"},We={class:"font-medium"},Ke=R(()=>i("i",{class:"pi pi-chevron-down ml-auto"},null,-1)),Fe=["onClick"],ze=R(()=>i("i",{class:"pi pi-chart-line mr-2"},null,-1)),Ze={class:"font-medium"},Ye=z({__name:"AppSidebar",setup(e){const{t}=ee(),{setStateFilter:n}=Se(),{setStateFilter:o}=ge(),{setStateFilter:c}=we(),{setStateFilter:s}=ke(),p=ce(),_=[{key:"1",label:t("sidebar.settings"),icon:"pi pi-cog",color:"text-black-500",to:"settings",children:[{key:"1",label:t("sidebar.country"),icon:"pi pi-chart-line",color:"text-red-500",to:"country",roles:[l.SUPER_ADMIN,l.ADMIN,l.USER],permission:y.COUNTRY.VIEW},{key:"2",label:t("sidebar.province"),icon:"pi pi-chart-line",color:"text-red-500",to:"province",roles:[l.SUPER_ADMIN,l.ADMIN,l.USER],permission:y.PROVINCE.VIEW},{key:"3",label:t("sidebar.district"),icon:"pi pi-chart-line",color:"text-red-500",to:"district",roles:[l.SUPER_ADMIN,l.ADMIN,l.USER],permission:y.DISTRICT.VIEW},{key:"5",label:t("sidebar.service"),icon:"pi pi-chart-line",color:"text-red-500",to:"real.estate.services",roles:[l.SUPER_ADMIN,l.ADMIN,l.USER],permission:y.SERVICE_CHARGE.VIEW},{key:"6",label:t("sidebar.user"),icon:"pi pi-chart-line",color:"text-red-500",to:"admin.user",roles:[l.SUPER_ADMIN,l.ADMIN,l.USER],permission:y.ADMIN_USER.VIEW},{key:"7",label:t("sidebar.house"),icon:"pi pi-chart-line",color:"text-red-500",to:"owner.house",roles:[l.ADMIN_OWNER,l.USER_OWNER],permission:y.REAL_ESTATE.VIEW},{key:"8",label:t("sidebar.payment_service"),icon:"pi pi-chart-line",color:"text-red-500",to:"owner.payment.service",roles:[l.ADMIN_OWNER,l.USER_OWNER],permission:y.PAYMENT_REAL_ESTATE.VIEW},{key:"9",label:t("sidebar.appointment"),icon:"pi pi-chart-line",color:"text-red-500",to:"owner.appointment",roles:[l.ADMIN_OWNER,l.USER_OWNER],permission:y.APPOINTMENT.VIEW},{key:"10",label:t("sidebar.rent_buy"),icon:"pi pi-chart-line",color:"text-red-500",to:"owner.rent.buy",roles:[l.ADMIN_OWNER,l.USER_OWNER],permission:y.RENT_BUY.VIEW}]},{key:"1",label:t("sidebar.report"),icon:"pi pi-chart-line",color:"text-black-500",to:"settings",children:[]}],I=["province","country","district","real.estate.services"],g=async v=>{I.includes(v)&&(c.page=1,c.limit=10,n.page=1,n.limit=10,o.page=1,o.limit=10,s.page=1,s.limit=10)},B=async v=>{await g(v),p.push({name:v})},P=localStorage.getItem("roles")||"",k=P?JSON.parse(P):[],E=localStorage.getItem("permissions")||"",u=P?JSON.parse(E):[],h=v=>k.includes(l.SUPER_ADMIN)||k.includes(l.ADMIN)?!0:u.includes(v),ae=(v,x)=>k.includes(l.SUPER_ADMIN)||k.includes(l.ADMIN)||k.includes(l.ADMIN_OWNER)?v.some(A=>k.includes(A)):u.includes(x);return(v,x)=>{const A=W("ripple"),le=W("styleclass");return r(),a("aside",xe,[i("div",Ce,[i("div",{onClick:x[0]||(x[0]=S=>f(p).push({name:"dashboard"})),class:"flex align-items-center justify-content-center pt-3 overflow-hidden cursor-pointer"},Le),Oe,i("div",De,[i("ul",$e,[h(f(y).CUSTOMER.VIEW)?(r(),a("li",Ne,[O((r(),a("a",{onClick:x[1]||(x[1]=S=>B("customer")),class:w([{"bg-highlight":f(p).currentRoute.value.name==="customer"},"flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple"])},[Be,i("span",Pe,D(v.$t("sidebar.customer")),1)],2)),[[A]])])):m("",!0),h(f(y).PAYMENT_HISTORY.VIEW)?(r(),a("li",Me,[O((r(),a("a",{onClick:x[2]||(x[2]=S=>B("admin.payment.history")),class:w([{"bg-highlight":f(p).currentRoute.value.name==="admin.payment.history"},"flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple"])},[Ue,i("span",Te,D(v.$t("sidebar.payment_history")),1)],2)),[[A]])])):m("",!0)]),i("ul",Ve,[(r(),a(N,null,H(_,S=>i("li",{key:S.key},[O((r(),a("div",je,[i("i",{class:w(`${S.icon} ${S.color} mr-2`)},null,2),i("span",We,D(S.label),1),Ke])),[[A],[le,{selector:"@next",enterClass:"hidden",enterActiveClass:"slidedown",leaveToClass:"hidden",leaveActiveClass:"slideup"}]]),i("ul",{class:w(["list-none py-0 pl-3 pr-0 m-0 overflow-y-hidden transition-all transition-duration-400 transition-ease-in-out",{hidden:!["province","country","district","real.estate.services","owner.house","owner.payment.service","admin.user","owner.appointment","owner.rent.buy"].includes(String(f(p).currentRoute.value.name))}])},[(r(!0),a(N,null,H(S.children,M=>(r(),a("li",{key:S.key},[ae(M.roles,M.permission)?O((r(),a("a",{key:0,onClick:Kt=>B(M.to),class:w([{"bg-highlight":f(p).currentRoute.value.name===M.to},"flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple"])},[ze,i("span",Ze,D(M.label),1)],10,Fe)),[[A]]):m("",!0)]))),128))],2)])),64))])])])])}}}),He=G(Ye,[["__scopeId","data-v-3a8d789a"]]),Ge={},Je={class:"layout-footer flex flex-column text-white font-bold surface-overlay"},qe=i("span",{class:"font-medium ml-2 text-color"},"Ⓒ2023 Haltech | All Rights Reserved",-1),Xe=[qe];function Qe(e,t){return r(),a("footer",Je,Xe)}const et=G(Ge,[["render",Qe]]);var tt=`
@layer primevue {
    .p-breadcrumb {
        overflow-x: auto;
    }
...
`,$t={root:"p-progress-spinner",spinner:"p-progress-spinner-svg",circle:"p-progress-spinner-circle"},Nt=J.extend({name:"progressspinner",css:Dt,classes:$t}),Bt={name:"BaseProgressSpinner",extends:Z,props:{strokeWidth:{type:String,default:"2"},fill:{type:String,default:"none"},animationDuration:{type:String,default:"2s"}},style:Nt,provide:function(){return{$parentInstance:this}}},oe={name:"ProgressSpinner",extends:Bt,computed:{svgStyle:function(){return{"animation-duration":this.animationDuration}}}},Pt=["fill","stroke-width"];function Mt(e,t,n,o,c,s){return r(),a("div",d({class:e.cx("root"),role:"progressbar"},e.ptm("root"),{"data-pc-name":"progressspinner"}),[(r(),a("svg",d({class:e.cx("spinner"),viewBox:"25 25 50 50",style:s.svgStyle},e.ptm("spinner")),[i("circle",d({class:e.cx("circle"),cx:"50",cy:"50",r:"20",fill:e.fill,"stroke-width":e.strokeWidth,strokeMiterlimit:"10"},e.ptm("circle")),null,16,Pt)],16))],16)}oe.render=Mt;const Ut={class:"flex flex-column justify-content-center align-items-center text-center",style:{"margin-top":"150px"}},Tt={class:"mb-3"},Vt=i("div",null,[i("h3",null,"ກຳລັງໂຫຼດ...")],-1),jt=z({__name:"LoadingComponent",setup(e){return(t,n)=>(r(),a("div",Ut,[i("div",Tt,[b(f(oe))]),Vt]))}}),Wt={class:"layout-main-container surface-ground"},en=z({__name:"AppLayout",setup(e){const t=L(!0);return(n,o)=>{const c=F("router-view");return r(),a("div",{class:w([t.value?"layout-mobile-active":"","layout-container"])},[b(He,{style:q(t.value?"width: 15rem;":"width: 0rem")},null,8,["style"]),i("div",{class:"layout-content",style:q(t.value?"":"margin-left: 0rem;transition: 0.2s ease-in-out;")},[b(Ot,{onToggleSidebar:o[0]||(o[0]=()=>t.value=!t.value)}),i("main",Wt,[b(c,null,{default:$(({Component:s})=>[s?(r(),C(ye,{key:0},{fallback:$(()=>[b(jt)]),default:$(()=>[(r(),C(K(s)))]),_:2},1024)):m("",!0)]),_:1})]),b(et)],4),i("div",{class:"layout-mask",onClick:o[1]||(o[1]=()=>t.value=!t.value)})],2)}}});export{en as default};
