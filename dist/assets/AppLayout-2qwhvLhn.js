import{d as z,u as ee,a as le,G as s,b,r as j,c as l,e as i,f as v,w as L,n as E,t as N,g as y,F as U,h as H,o as a,p as te,i as ne,_ as G,B as ie,s as J,m as d,j as C,k as K,l as F,q as M,v as g,Z,D as V,x as ce,R as de,y as ue,z as pe,A as D,T as me,C as A,E as fe,H as be,I as he,J as q,S as ve}from"./index-kU_R0p5R.js";import{p as ye}from"./province.store-iKSoRIKX.js";import{r as ge}from"./real-estate-service.store-rXgsR7FJ.js";import{d as ke}from"./district.store-bbOUSpIP.js";import{c as Se}from"./country.store-dtZE7War.js";import{s as we}from"./index.esm-OcPB7vHP.js";import{u as _e}from"./auth.store-2D8-V5Op.js";import{s as Ee}from"./dropdown.esm-cvAemcgL.js";import{s as Re}from"./progressspinner.esm-oAypuuR3.js";import"./axios.config-HGXv1ygo.js";import"./overlayeventbus.esm-sQdJG6dl.js";const P=e=>(te("data-v-2861a2d0"),e=e(),ne(),e),Ie={class:"shadow-1 h-screen fixed z-2 surface-overlay"},xe={class:"flex flex-column h-full white-space-nowrap"},Ce=P(()=>i("img",{src:"https://logomaker.designfreelogoonline.com/media/productdesigner/logo/resized/1286_bird-01.png",style:{width:"38px"}},null,-1)),Oe=P(()=>i("br",null,null,-1)),Ae={class:"overflow-y-auto"},Le={class:"list-none p-0 m-0 overflow-hidden"},Ne={key:0},De=P(()=>i("i",{class:"pi pi-users mr-2"},null,-1)),Ue={class:"font-medium"},Pe={key:1},$e=P(()=>i("i",{class:"pi pi-chart-line mr-2"},null,-1)),Be={class:"font-medium"},Me={class:"list-none p-0 m-0 overflow-hidden"},Te={class:"flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple"},We={class:"font-medium"},Ve=P(()=>i("i",{class:"pi pi-chevron-down ml-auto"},null,-1)),je=["onClick"],Ke=P(()=>i("i",{class:"pi pi-chart-line mr-2"},null,-1)),Fe={class:"font-medium"},ze=z({__name:"AppSidebar",setup(e){const{t}=ee(),{setStateFilter:n}=ke(),{setStateFilter:o}=ye(),{setStateFilter:c}=Se(),{setStateFilter:r}=ge(),f=le(),R=[{key:"1",label:t("sidebar.settings"),icon:"pi pi-cog",color:"text-black-500",to:"settings",children:[{key:"1",label:t("sidebar.country"),name:"admin-country",icon:"pi pi-chart-line",color:"text-red-500",to:"country",roles:[s.SUPER_ADMIN,s.ADMIN,s.USER],permission:b.COUNTRY.VIEW},{key:"2",label:t("sidebar.province"),name:"admin-province",icon:"pi pi-chart-line",color:"text-red-500",to:"province",roles:[s.SUPER_ADMIN,s.ADMIN,s.USER],permission:b.PROVINCE.VIEW},{key:"3",label:t("sidebar.district"),name:"admin-district",icon:"pi pi-chart-line",color:"text-red-500",to:"district",roles:[s.SUPER_ADMIN,s.ADMIN,s.USER],permission:b.DISTRICT.VIEW},{key:"5",label:t("sidebar.service"),name:"admin-service-charge",icon:"pi pi-chart-line",color:"text-red-500",to:"real.estate.services",roles:[s.SUPER_ADMIN,s.ADMIN,s.USER],permission:b.SERVICE_CHARGE.VIEW},{key:"6",label:t("sidebar.user"),name:"admin-user",icon:"pi pi-chart-line",color:"text-red-500",to:"admin.user",roles:[s.SUPER_ADMIN,s.ADMIN,s.USER],permission:b.ADMIN_USER.VIEW},{key:"7",label:t("sidebar.house"),name:"owner-real-estate",icon:"pi pi-chart-line",color:"text-red-500",to:"owner.house",roles:[s.ADMIN_OWNER,s.USER_OWNER],permission:b.REAL_ESTATE.VIEW},{key:"8",label:t("sidebar.payment_service"),name:"owner-payment-service",icon:"pi pi-chart-line",color:"text-red-500",to:"owner.payment.service",roles:[s.ADMIN_OWNER,s.USER_OWNER],permission:b.PAYMENT_REAL_ESTATE.VIEW},{key:"9",label:t("sidebar.appointment"),name:"owner-appointment",icon:"pi pi-chart-line",color:"text-red-500",to:"owner.appointment",roles:[s.ADMIN_OWNER,s.USER_OWNER],permission:b.APPOINTMENT.VIEW},{key:"10",label:t("sidebar.rent_buy"),name:"owner-rent-buy",icon:"pi pi-chart-line",color:"text-red-500",to:"owner.rent.buy",roles:[s.ADMIN_OWNER,s.USER_OWNER],permission:b.RENT_BUY.VIEW},{key:"11",label:t("sidebar.user"),name:"owner-user",icon:"pi pi-chart-line",color:"text-red-500",to:"owner.user",roles:[s.ADMIN_OWNER,s.USER_OWNER],permission:b.OWNER_USER.VIEW},{key:"12",label:t("sidebar.real_estate_type"),name:"owner-user",icon:"pi pi-chart-line",color:"text-red-500",to:"real.estate.type",roles:[s.SUPER_ADMIN,s.ADMIN,s.USER],permission:b.REAL_ESTATE_TYPE.VIEW},{key:"13",label:t("sidebar.footer"),name:"owner-user",icon:"pi pi-chart-line",color:"text-red-500",to:"footer",roles:[s.SUPER_ADMIN,s.ADMIN,s.USER],permission:b.FOOTER.VIEW}]},{key:"1",label:t("sidebar.report"),icon:"pi pi-chart-line",color:"text-black-500",to:"settings",children:[]}],I=["province","country","district","real.estate.services"],w=async S=>{I.includes(S)&&(c.page=1,c.limit=10,n.page=1,n.limit=10,o.page=1,o.limit=10,r.page=1,r.limit=10)},$=async S=>{await w(S),f.push({name:S})},B=localStorage.getItem("roles")||"",p=B?JSON.parse(B):[],x=localStorage.getItem("permissions")||"",m=B?JSON.parse(x):[],k=S=>p.includes(s.SUPER_ADMIN)||p.includes(s.ADMIN)?!0:m.includes(S),ae=(S,u,h)=>p.includes(s.SUPER_ADMIN)||p.includes(s.ADMIN)||p.includes(s.ADMIN_OWNER)?S.some(Y=>p.includes(Y)):h==="owner-user"?!!(u==="view-user"&&p.includes(s.USER_OWNER)):h==="admin-user"?!!(u==="view-user"&&p.includes(s.USER)):h==="owner-real-estate"?!!(u==="view-real-estate"&&p.includes(s.USER_OWNER)):h==="admin-real-estate"?!!(u==="view-real-estate"&&p.includes(s.USER)):h==="owner-appointment"?!!(u==="view-appointment"&&p.includes(s.USER_OWNER)):h==="admin-appointment"?!!(u==="view-appointment"&&p.includes(s.USER)):h==="owner-rent-buy"?!!(u==="view-rent-buy"&&p.includes(s.USER_OWNER)):h==="admin-rent-buy"?!!(u==="view-rent-buy"&&p.includes(s.USER)):m.includes(u);return(S,u)=>{const h=j("ripple"),Y=j("styleclass");return a(),l("aside",Ie,[i("div",xe,[i("div",{onClick:u[1]||(u[1]=_=>v(f).push({name:"dashboard"})),class:"flex align-items-center justify-content-center pt-3 overflow-hidden cursor-pointer"},[Ce,i("span",{class:"font-bold text-3xl",style:{"margin-left":"10px"},onClick:u[0]||(u[0]=_=>v(f).push({name:"home"}))},"UK LAO")]),Oe,i("div",Ae,[i("ul",Le,[k(v(b).CUSTOMER.VIEW)?(a(),l("li",Ne,[L((a(),l("a",{onClick:u[2]||(u[2]=_=>$("customer")),class:E([{"bg-highlight":v(f).currentRoute.value.name==="customer"},"flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple"])},[De,i("span",Ue,N(S.$t("sidebar.customer")),1)],2)),[[h]])])):y("",!0),k(v(b).PAYMENT_HISTORY.VIEW)?(a(),l("li",Pe,[L((a(),l("a",{onClick:u[3]||(u[3]=_=>$("admin.payment.history")),class:E([{"bg-highlight":v(f).currentRoute.value.name==="admin.payment.history"},"flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple"])},[$e,i("span",Be,N(S.$t("sidebar.payment_history")),1)],2)),[[h]])])):y("",!0)]),i("ul",Me,[(a(),l(U,null,H(R,_=>i("li",{key:_.key},[L((a(),l("div",Te,[i("i",{class:E(`${_.icon} ${_.color} mr-2`)},null,2),i("span",We,N(_.label),1),Ve])),[[h],[Y,{selector:"@next",enterClass:"hidden",enterActiveClass:"slidedown",leaveToClass:"hidden",leaveActiveClass:"slideup"}]]),i("ul",{class:E(["list-none py-0 pl-3 pr-0 m-0 overflow-y-hidden transition-all transition-duration-400 transition-ease-in-out",{hidden:!["province","country","district","real.estate.services","owner.house","owner.payment.service","admin.user","owner.appointment","owner.rent.buy","owner.user","real.estate.type","footer"].includes(String(v(f).currentRoute.value.name))}])},[(a(!0),l(U,null,H(_.children,O=>(a(),l("li",{key:_.key},[ae(O.roles,O.permission,O.name)?L((a(),l("a",{key:0,onClick:Pt=>$(O.to),class:E([{"bg-highlight":v(f).currentRoute.value.name===O.to},"flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple"])},[Ke,i("span",Fe,N(O.label),1)],10,je)),[[h]]):y("",!0)]))),128))],2)])),64))])])])])}}}),Ye=G(ze,[["__scopeId","data-v-2861a2d0"]]),Ze={},He={class:"layout-footer flex flex-column text-white font-bold surface-overlay"},Ge=i("span",{class:"font-medium ml-2 text-color"},"Ⓒ2023 Haltech | All Rights Reserved",-1),Je=[Ge];function qe(e,t){return a(),l("footer",He,Je)}const Xe=G(Ze,[["render",qe]]);var Qe=`
@layer primevue {
    .p-breadcrumb {
        overflow-x: auto;
    }
